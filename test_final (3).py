...
Original file is located at
    https://colab.research.google.com/drive/1FiZWKSmqOpU03b4jb_lh_XeDcwKXFUVb
"""
...
if uploaded_file is not None:
    ...
    # Slice the data to only use rows 2 to 7 and columns 2 to 7
    data = data.iloc[1:7, 1:7]  # Rows 2 to 7 (index 1:7) and Columns 2 to 7 (index 1:7)
